...
import com.nbbsw.contacts.BirdContactsStatusActivity;
/**
...
public class PeopleActivity extends ContactsActivity implements
    ...
    protected void onCreate(Bundle savedState) {
        ...
        LogUtils.d(TAG, "[Performance test][Contacts] loading data start time: ["
        ...
        /// M: op09
        ExtensionManager.getInstance().getContactListExtension().registerHostContext(this, null);
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (!processIntent(true)) {
            finish();
            LogUtils.w(TAG, "[onNewIntent]can not process intent:" + getIntent());
            return;
        }
    ...
    protected void onResume() {
        ...
        LogUtils.d(TAG, "call showContactsUnavailableFragmentIfNecessary in onresume");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        /// M: op09
        ExtensionManager.getInstance().getContactListExtension().addOptionsMenu(menu, null);
        /** @} */
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (mActionBarAdapter == null) {
            LogUtils.w(TAG, "[onPrepareOptionsMenu]mActionBarAdapter is null,return..");
            return true;
        }
        /// @}
		...
		//chengting,@20141223,begin
		boolean showContactStatus=BirdFeature.BIRD_CONTACTS_STATUS;
		if(isSearchMode){
			showContactStatus&=false;
		}else{
			int currentPosition = getTabPositionForTextDirection(mActionBarAdapter.getCurrentTab());
			showContactStatus&=(currentPosition==TabState.ALL);
		}
		makeMenuItemVisible(menu, R.id.menu_status_contact, showContactStatus);
		//chengting,@20141223,end		
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            /** @} */
            /**add by sunjunwei 20140529 begin*/
            case R.id.menu_status_contact: {
            	startActivity(new Intent(PeopleActivity.this, BirdContactsStatusActivity.class));
            	return true;
            }
            /**add by sunjunwei 20140529 end*/
        }
        return false;
    }
