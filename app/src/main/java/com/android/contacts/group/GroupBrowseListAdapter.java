...
public class GroupBrowseListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (entry.isFirstGroupInAccount()) {
            ...
            //changed by sunjuwnei for 201501303 begin
        ...
        if(BirdFeature.BIRD_DIALER_FTO){
        	memberCountString = ""+entry.getMemberCount();
        }
        //add by sunjunwei for fto 20150303 end
    ...
    protected int getGroupListItemLayout() {
    	//changed by sunjunwei fro fto 20150303
        return BirdFeature.BIRD_DIALER_FTO?R.layout.bird_fto_group_browse_list_item
        		:R.layout.group_browse_list_item;
    }
