...
//add by sunjunwei fro fto 20150303 begin
...
public class GroupBrowseListFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(byFTO){
			mRootView = inflater.inflate(R.layout.bird_fto_group_browse_list_fragment, null);
        ...
        if(byFTO){
        	((View)mRootView.findViewById(R.id.bird_dialer_title_view)).setVisibility(View.VISIBLE);
        	((View)mRootView.findViewById(R.id.bird_header_delete_button)).setVisibility(View.INVISIBLE);
        	((Button)mRootView.findViewById(R.id.bird_header_add_button)).setOnClickListener(new OnClickListener() {
				
				@Override
				public void onClick(View v) {
					// TODO Auto-generated method stub
					Log.i("sjw", "bird_header_add_button");
					ComponentName mComponentName = new ComponentName("com.android.contacts", "com.android.contacts.activities.GroupEditorActivity");
    ...
    private void configureVerticalScrollbar() {
        ...
        //changed by sunjuwnei for 20150303 begin
        if(byFTO){
        	mListView.setPadding(0, mListView.getPaddingTop(),
                    0, mListView.getPaddingBottom());
        }else{
        	mListView.setPadding(leftPadding, mListView.getPaddingTop(),
                    rightPadding, mListView.getPaddingBottom());
        }
        //changed by sunjunwei for 20150303 end
    }
