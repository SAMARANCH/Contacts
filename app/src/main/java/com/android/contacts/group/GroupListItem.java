...
public final class GroupListItem {
    ...
    private final int mAccountGroupMemberCount;

    public GroupListItem(String accountName, String accountType, String dataSet, long groupId,
            String title, boolean isFirstGroupInAccount, int memberCount, int accountGroupMemberCount) {
        ...
        ///M: For move to other group feature.
        mAccountGroupMemberCount = accountGroupMemberCount;
    }
