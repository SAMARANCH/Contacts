...
public class PhotoEditorView extends LinearLayout implements Editor {
    ...
    public void setValues(DataKind kind, ValuesDelta values, RawContactDelta state, boolean readOnly,
        ...
        if (values != null) {
            ...
            if (photoBytes != null) {
                ...
                LogUtils.d(TAG, "[setValues] setImageBitmap");
                mHasSetPhoto = true;
    ...
    public void setPhotoEntry(Bitmap photo) {
        ...
        LogUtils.d(TAG, "[setPhotoBitmap] setPhotoBitmap");
        mHasSetPhoto = true;
        mEntry.setFromTemplate(false);
    ...
    protected void resetDefault() {
        ...
        if (mDefaultIconDrawable != null) {
            ...
            //bird modify start
            mPhotoImageView.setImageDrawable(new LetterTileDrawableEx(getResources())
    ...
    /** M: For sim editor, it will disable the TriangleAffordance. @{ */
    private boolean mEnableTriangleAffordance = true;

    public void disableTriangleAffordance() {
        LogUtils.d(TAG, "disableTriangleAffordance");
        mEnableTriangleAffordance = false;
        // L-mr1, removed the mTriangleAffordance and mFrameView.
        // mTriangleAffordance.setVisibility(View.GONE);
        // mFrameView.setClickable(false);
    }
    /** @} */
}
