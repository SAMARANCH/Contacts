...
/*add by tianjianwei 2015/05/04 start*/
import com.nbbsw.contacts.BirdFeature;
import android.content.SharedPreferences;
import android.content.Context;
/*add by tianjianwei 2015/05/04 end*/
/**
...
public class ContactEditorAccountsChangedActivity extends Activity {
    ...
    /*add by tianjianwei 2015/05/04 start*/
    private boolean firstInContact = false;
    private String flag;
    ...
    protected void onResume() {
        ...
        if (numAccounts >= 2) {
            ...
            /*add Contact the default storage to SIM card start*/
            if(BirdFeature.BIRD_DEFAULT_CONTACT_SIM_CARD){
                sharedPreferences = getApplicationContext().getSharedPreferences("com.android.Contact", Context.MODE_PRIVATE);               
                firstInContact = sharedPreferences.getBoolean(flag, false);
                if(!firstInContact){
            ...
            /*add Contact the default storage to SIM card end*/
