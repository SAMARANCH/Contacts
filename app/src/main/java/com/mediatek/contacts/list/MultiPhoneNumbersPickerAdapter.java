...
public class MultiPhoneNumbersPickerAdapter extends DataKindPickerBaseAdapter {
    ...
    protected Uri configLoaderUri(long directoryId) {
        ...
        if (isSearchMode()) {
            ...
            uri = Phone.CONTENT_URI.buildUpon()
    ...
    protected void configureSelection(CursorLoader loader, long directoryId,
        ...
        ExtensionManager.getInstance().getRcsExtension().setListFilter(selection);
        /** @} */
    ...
    public Uri getDataUri(int position) {
        ...
        if (cursor != null) {
            ...
            LogUtils.w(TAG, "Cursor was null in getDataUri() call. Returning null instead.");
            return null;
        }
    }
    ...
    public long getDataId(int position) {
        ...
        if (cursor != null) {
            ...
            LogUtils.w(TAG, "Cursor was null in getDataId() call. Returning 0 instead.");
            return 0;
        }
    }
