...
public class VcsUtils {
    ...
    public static Cursor getCursorByAudioName(DefaultContactBrowseListFragment allFragment, ArrayList<String> audioNameList, CursorLoader loader, Context context) {
