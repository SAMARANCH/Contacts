...
//import src.com.android.contacts.list.Context;
...
public class MultiContactsPickerBaseFragment extends AbstractPickerFragment {
    ...
    protected void configureAdapter() {
        ...
        if(mFtoContactListFilter!=null){
        	mFilter = mFtoContactListFilter;
        	mFtoContactListFilter = null;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_CODE_ACCOUNT_FILTER) {
            if (getActivity() != null) {
                ...
                LogUtils.e(TAG, "getActivity() returns null during Fragment#onActivityResult()");
            }
        }
    }
    ...
    public MultiContactsPickerBaseFragment(){
    	
    }
    
    private ContactListFilter mFtoContactListFilter = null;
    
    public MultiContactsPickerBaseFragment(ContactListFilter mContactListFilter){
    	this.mFtoContactListFilter = mContactListFilter;
    }
