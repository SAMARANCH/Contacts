    ...
    public final class PickListItemCache {
        ...
        public final class PickListItemData {
            ...
            public String toString() {
                return "[PickListItemData]@" + hashCode() + " contactIndicator: " + contactIndicator + ", simIndex: "
                        + simIndex + ", displayName: " + displayName + ", lookupUri: " + lookupUri;
            }
