...
public class ContactsMultiDeletionFragment extends MultiContactsPickerBaseFragment {
	...
	//for read only contacts,chengting,@20141222,begin
	protected boolean isInstanceOfContactsMultiDeletionFragment(){
    	return true;
    }
	//for read only contacts,chengting,@20141222,end
	//add by sunjunwei for fto 20150303 begin
    public ContactsMultiDeletionFragment(){
    	
    }
    public ContactsMultiDeletionFragment(ContactListFilter mContactListFilter){
    	super(mContactListFilter);
    }
